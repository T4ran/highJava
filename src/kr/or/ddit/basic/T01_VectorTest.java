...
public class T01_VectorTest {
	public static void main(String[] args) {
		...
		// set(index, 데이터) => 벡터의 index번쨰의 값을 주어진 '데이터'로
		// 덮어쓴다. (반환값 : 원래의 데이터)
		...
		*/
		...
		Vector<Integer> v3 = new Vector<Integer>();	//int만 저장가능
		...
		/*
			향상된 for문
			for(자료형인 변수명 : 배열변수나 Collection계열 변수)
			{
				처리할 내용들;
			}
		...
		*/
		...
		Vector v = new Vector(5);	//용량이 5인 벡터 생성
		v.add("가나다");
		v.add("라마바");
		v.add(3);
